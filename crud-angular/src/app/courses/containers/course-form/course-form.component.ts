...
@Component({
    ...
    standalone: true,
    imports: [MatCard, MatToolbar, CoursesListComponent, MatCardContent, ReactiveFormsModule, MatFormField, MatInput, MatHint, NgIf, MatError, MatLabel, MatSelect, MatOption, MatIconButton, MatIcon, NgFor, MatPrefix, MatCardActions, MatButton]
})
