...
@Component({
    ...
    standalone: true,
    imports: [MatCard, MatToolbar, CoursesListComponent, MatCardContent, ReactiveFormsModule, MatFormField, MatInput, MatHint, MatError, MatLabel, MatSelect, MatOption, MatIconButton, MatIcon, MatPrefix, MatCardActions, MatButton]
})
